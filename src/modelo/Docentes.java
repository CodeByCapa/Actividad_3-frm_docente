...
public class Docentes extends Persona {
    ...
    public Docentes(int id, String nit, String nombres, String apellidos, String direccion, String telefono, String fecha_nacimiento,
                    String codigo_docente, double salario, String fecha_ingreso_laborar, String fecha_ingreso_registro) {
    ...
    public void setCodigo_docentes(String codigo_docente) {
        this.codigo_docente = codigo_docente;
    }
    ...
    public DefaultTableModel leer() {
        ...
        try {
            cn = new Conexion();
            cn.abrir_conexion();
            String query = "SELECT id_docente,nit,nombres,apellidos,direccion,telefono,fecha_nacimiento, " +
                           "codigo_docente,salario,fecha_ingreso_laborar,fecha_ingreso_registro FROM docentes;";
            ResultSet consulta = cn.conexionBD.createStatement().executeQuery(query);

            String encabezado[] = {"ID Docente","Nit","Nombres","Apellidos","Dirección","Teléfono","Nacimiento","Código","Salario","Ingreso Laboral","Ingreso Registro"};
    ...
    public void agregar() {
        try {
            ...
            cn = new Conexion();
            cn.abrir_conexion();
            String query = "INSERT INTO docentes (nit,nombres,apellidos,direccion,telefono,fecha_nacimiento,codigo_docente,salario,fecha_ingreso_laborar,fecha_ingreso_registro) " +
                           "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
